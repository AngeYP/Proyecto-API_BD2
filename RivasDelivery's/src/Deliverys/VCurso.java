...
public class VCurso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(cs_fecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 150, 220, 40));

        jLabel2.setFont(new java.awt.Font("Helvetica", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(238, 238, 238));
        jLabel2.setText("Cod Curso");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 150, 40));

        jLabel1.setFont(new java.awt.Font("Helvetica", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(238, 238, 238));
        jLabel1.setText("Fecha");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 150, 40));
        ...
        tf_codigo.setForeground(new java.awt.Color(238, 238, 238));
        tf_codigo.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        tf_codigo.setBorder(null);
        jPanel2.add(tf_codigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 90, 220, 40));

        jLabel3.setFont(new java.awt.Font("Helvetica", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(238, 238, 238));
        jLabel3.setText("Nucleo");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 150, 40));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 440, 210));
    ...
    private void btn_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptarActionPerformed
        if (cb_nucleo.getSelectedIndex()>0 && cs_fecha.getText()!=""&&!tf_codigo.equals("")) {
            crud.insertarCurso(crud.buscarCodNucleo(cb_nucleo.getSelectedItem().toString()), tf_codigo.getText(), cs_fecha.getText());
