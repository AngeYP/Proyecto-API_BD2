 ...
 * @author Noel Roberto
 */
public class VClientePaq extends javax.swing.JFrame {
    Conexion conexion = new Conexion();
    CRUD.CRUDEmpleadoPaq CRUDPaq;
    public static String codPaq;

    /**
     * Creates new form VClientePaq
     */
    public VClientePaq() {
        initComponents();
        CRUDPaq = new CRUDEmpleadoPaq(conexion.conectar());
        tf_encomienda.setText(VCliente.codEnco);
        CRUDPaq.comboboxCodPaquetes(cb_codigo, VCliente.codEnco);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_aceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 650, 140, 40));
        ...
        tf_ancho.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel2.add(tf_ancho, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 150, 300, 40));

        tf_alto.setEditable(false);
        ...
        tf_alto.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel2.add(tf_alto, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 210, 300, 40));

        tf_profundidad.setEditable(false);
        ...
        tf_profundidad.setHorizontalAlignment(javax.swing.JTextField.CENTER);
    ...
    private void cb_codigoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cb_codigoItemStateChanged
        if(this.cb_codigo.getSelectedIndex()>0){
            ...
            datosPaq=this.CRUDPaq.buscarPaq(this.cb_codigo.getSelectedItem().toString(), VCliente.codEnco);
    ...
    private void btn_articulosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_articulosActionPerformed
        codPaq=cb_codigo.getSelectedItem().toString();
        new VClienteArt().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VClientePaq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VClientePaq().setVisible(true);
            }
        });
    }
