 ...
 * @author angel
 */
public class VAdministradorNucleo extends javax.swing.JFrame {
     ...
     */
    public VAdministradorNucleo() {
        initComponents();
        this.datosBase.comboboxPaises(JCB_cod_pais);
    }

    public VAdministradorNucleo(String cedulaEmp) {
        initComponents();
        cedulaE = cedulaEmp;
        this.datosBase.comboboxPaises(JCB_cod_pais);
    }
  ...
  private void initComponents() {
    ...
    btn_direcciones.setBackground(new java.awt.Color(253, 112, 20));
    btn_direcciones.setFont(new java.awt.Font("Helvetica", 1, 18)); // NOI18N
    btn_direcciones.setForeground(new java.awt.Color(238, 238, 238));
    btn_direcciones.setText("Direcciones");
    btn_direcciones.setBorderPainted(false);
    ...
    jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 130, 740, 380));
  ...
  private void btn_salirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_salirActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAdministradorNucleo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
