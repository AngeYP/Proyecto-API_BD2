 ...
 * @author Noel Roberto
 */
public class VClienteArt extends javax.swing.JFrame {
    Conexion conexion= new Conexion();
    CRUD.CRUDEmpleadoArt CRUDArticulos;

    /**
     * Creates new form VClienteArt
     */
    public VClienteArt() {
        initComponents();
        CRUDArticulos = new CRUDEmpleadoArt(conexion.conectar());
        tf_codEncomienda.setText(VCliente.codEnco);
        tf_codPaquete.setText(VClientePaq.codPaq);
        CRUDArticulos.comboboxCodArticulos(cb_nombreArt, VCliente.codEnco, VClientePaq.codPaq);
    }
    ...
    private void initComponents() {
        ...
        tf_codPaquete.setEditable(false);
        ...
        jPanel1.add(btn_aceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 650, 140, 40));
        ...
        tf_codEncomienda.setEditable(false);
    ...
    private void cb_nombreArtItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cb_nombreArtItemStateChanged
        if(this.cb_nombreArt.getSelectedIndex()>0){
            ...
            datosPaq =this.CRUDArticulos.buscarArticulos(this.cb_nombreArt.getSelectedItem().toString(),VClientePaq.codPaq,VCliente.codEnco);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VClienteArt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
